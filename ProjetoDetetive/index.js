...
const jogoDetetive = () => {
  ...
  const pergunta1 = prompt("Você telefonou para a vítima? [S/N]: ".gray)
    .slice(0, 1)
    .toUpperCase();
  ...
  const pergunta2 = prompt("Você esteve no local do crime? [S/N]:".gray)
    .slice(0, 1)
    .toUpperCase();
  ...
  const pergunta3 = prompt("Você mora perto da vítima? [S/N]:".gray)
    .slice(0, 1)
    .toUpperCase();
  ...
  const pergunta4 = prompt("Você devia para a vítima? [S/N]:".gray)
    .slice(0, 1)
    .toUpperCase();
  ...
  const pergunta5 = prompt("Você já trabalhou com a vítima? [S/N]: ".gray)
    .slice(0, 1)
    .toUpperCase();
  ...
  if (pergunta1 == "S") contador = contador + 1;

  if (pergunta2 == "S") contador = contador + 1;

  if (pergunta3 == "S") contador = contador + 1;

  if (pergunta4 == "S") contador = contador + 1;

  if (pergunta5 == "S") contador = contador + 1;
  ...
  if (contador == 2) console.log('"Você é Suspeito"'.yellow);
  else if (contador == 3 || contador == 4)
    console.log('"Você é Cúmplice"'.yellow);
  else if (contador == 5) console.log('"Você é o Assassino"'.red);
  else console.log('"Você é inocente"'.green);
};
